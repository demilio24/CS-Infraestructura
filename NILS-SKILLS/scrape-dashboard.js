...
function buildDashboard() {
  ...
  const html = [
    ...
    '.grid-wrap{overflow-x:auto;padding-bottom:2px}',
    '.activity-grid{display:flex;gap:2px;max-height:40px}',
    '.week-col{display:flex;flex-direction:column;gap:2px;flex:1}',
    '.day-cell{width:100%;aspect-ratio:1;max-height:5px;min-width:4px;border-radius:1px;background:var(--surface2);position:relative;cursor:default}',
